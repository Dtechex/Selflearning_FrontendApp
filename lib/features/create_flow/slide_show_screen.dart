...
class _SlideShowScreenState extends State<SlideShowScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title:  Text("${widget.flowName.toString()}")),
      body: Scaffold(
        body: Column(
...
class _FrontPageWidgetState extends State<FrontPageWidget> {
              ...
              Expanded(
                child:
                    _isLoading
                      ...
                      imageUrl: "https://backend.savant.app/image/${widget.promtModel![widget.index].side1Content}",
  ...
  Future<void> initVideo() async{
    print('https://backend.savant.app/public/video/${widget.promtModel![widget.index].side1Content}');
    flickManager = FlickManager(
      videoPlayerController: VideoPlayerController.network('https://backend.savant.app/video/${widget.promtModel![widget.index].side1Content}'),
    );
    setState(() { _isLoading = false;});
  }
